const CACHE = "brisa-v11";
const ASSETS = ["./", "./index.html", "./styles.css", "./hourly.css", "./daily.css", "./sunset.css", "./food.css", "./tides.css", "./surf-forecast.css", "./app.js", "./manifest.webmanifest"];
